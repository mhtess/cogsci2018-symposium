...
The symposium will consist of four talks, described below, by experts representing philosophy, linguistics, computational modeling, and developmental psychology.
...
I argue that these cases go far beyond the instances \citeA{leslie2008generics} has emphasized (``Mosquitos carry the West Nile virus''), and in such instances the notion of non-conforming individuals being regarded as ``exceptions'' seems attenuated if not absent altogether.
